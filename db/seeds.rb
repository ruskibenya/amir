...
activities_attributes = [
  ...
  address: "HaAri St 100, Tsfat, Israel",
  city: "Tsfat",
  meeting_point: false,
  category: "Religious",
  ...
  address: "Jerusalem St 70, Tsfat, Israel",
  city: "Tsfat",
  meeting_point: true,
  category: "Food & Drink",
  tour_id: rabea_birthright.id,
  ...
  address: "Ha-Nasi Weizman St 1, Afula, Israel",
  city: "Afula",
  meeting_point: false,
  category: "Other",
  tour_id: rabea_birthright.id,
  ...
  address: "Ha-Gdud ha-Shlishi St 106, Tsfat",
  city: "Tsfat",
  meeting_point: false,
  category: "Lecture",
  tour_id: rabea_birthright.id,
  ...
  address: "6 Haaravot, Qatsrin, Israel",
  city: "Qatsrin",
  meeting_point: false,
  category: "Travel & Outdoor",
  tour_id: rabea_birthright.id,
  ...
  address: "Tet Zayin St streeet 1a, Tsfat",
  city: "Tsfat",
  meeting_point: false,
  category: "Travel & Outdoor",
  tour_id: rabea_birthright.id,
  ...
  {
  name: "Party @ Tsfat",
  description: "See another side of your group mates at Tsfat! Have fun with the local youth. Plenty of dancing, laughing, most importantly Tubi!",
  address: "HaPalmach St 8, Tsfat",
  city: "Tsfat",
  meeting_point: false,
  category: "Lecture",
  tour_id: rabea_birthright.id,
  ...
  address: "Carmey Avdat Farm, Midreshet Ben-Gurion, Israel ",
